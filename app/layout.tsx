...
const description =
  "Farmacêutico CRF/SP 58.519 com trajetória em operação farmacêutica, atendimento, treinamento, indicadores, educação em saúde e inteligência artificial aplicada à produtividade.";

export const metadata: Metadata = {
  metadataBase: new URL(site.url),
  title: {
    default: "Thiago Piola | Farmacêutico CRF/SP 58.519 — Tecnologia e Inteligência Comercial em Saúde",
  ...
  keywords: [
    ...
    "treinamento em farmácia",
    "inteligência comercial em saúde",
    "indústria farmacêutica",
    "execução comercial farma",
    ...
    "performance comercial no varejo farmacêutico",
    "gestão farmácia",
    "compliance ANVISA",
    "n8n automação",
    "Google GEAR",
  ...
  openGraph: {
    ...
    title: "Thiago Piola | Farmacêutico CRF/SP 58.519 — Tecnologia e Inteligência Comercial em Saúde",
    description,
    countryName: "Brasil",
    firstName: "Thiago",
    lastName: "Piola",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Thiago Piola — Farmacêutico CRF/SP 58.519 — Tecnologia e Inteligência Comercial em Saúde",
        type: "image/webp",
      },
    ],
  },
