...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "recrutamento farmacêutico",
    "vaga para farmacêutico",
    "oportunidade indústria farmacêutica",
    "executivo farmacêutico",
    "gerente de contas farmacêutico",
    ...
    "treinamento corporativo farma",
    "compliance ANVISA",
    "compliance farmacêutico",
    "boas práticas farmacêuticas",
    "BPF indústria farmacêutica",
    ...
    "gerente de território farmacêutico",
    "especialista em automação farmacêutica",
    "engenheiro de IA farmácia",
    "B2B pharma Brazil",
