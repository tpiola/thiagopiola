...
export default function BlogPostPage({ slug }: { slug: string }) {
  ...
  const { title, summary, content, source } = getPost(post, locale);
      ...
      <main className="min-h-screen bg-surface text-foreground">
        ...
        <section className="border-b border-border pt-32 pb-20 md:pt-40 md:pb-24">
          <div className="mx-auto max-w-3xl px-5 md:px-8">
            ...
            >
              ...
              <h1 className="text-[clamp(2rem,5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-foreground">
                {title}
              </h1>
        ...
        <section className="py-16 md:py-20">
          <article className="mx-auto max-w-3xl px-5 md:px-8">
            <div className="prose prose-sm md:prose-base max-w-none prose-headings:text-foreground prose-p:text-muted prose-p:leading-relaxed prose-a:text-[var(--brand)]">
